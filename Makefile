...
# Template: app
# Command: D:\Qt\5.9.1\mingw53_32\bin\qmake.exe -o Makefile redirecionador.pro -spec win32-g++
#############################################################################
